<?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM products WHERE id_produit= :userid");
...
<span>Generic Name : </span><input type="text" style="width:265px; height:30px;"  name="gen" value="<?php echo $row['nom_de_famille']; ?>" /><br>
...
<span>Selling Price : </span><input type="text" style="width:265px; height:30px;" id="txt1" name="prix" value="<?php echo $row['prix']; ?>" onkeyup="sum();" Required/><br>
