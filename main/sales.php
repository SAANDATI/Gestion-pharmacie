...
<option></option>
	...
	?>
		<option value="<?php echo $row['id_produit'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['nom_de_famille']; ?> - <?php echo $row['nom_du_produit']; ?> | Expires at: <?php echo $row['expiry_date']; ?></option>
	<?php
				}
			?>
</select>
